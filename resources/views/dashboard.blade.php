    ...
    <div class="col-xl-4 col-sm-6">
        ...
        <div class="card customer mt-4">
            ...
            <div class="customer-wrapper px-3">
                ...
                @endphp
                <img class="customer-image" alt="no available image" src="https://picsum.photos/id/{{ $randomProfileNumber }}/40/40.jpg">
                ...
                <p class="customer-date">{{ \Carbon\Carbon::parse($message->message_date)->formatLocalized('%d-%m-%Y') }}</p>
            </div>
            @endforeach
...
<!-- Modal -->
<div class="modal fade" id="fullMessageModal{{ $message->id }}" tabindex="-1" role="dialog" aria-labelledby="fullMessageModal{{ $message->id }}Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fullMessageModal{{ $message->id }}Label">Pesan Penuh</h5>
...
<style>
    ...
    .customer-wrapper {
        display: grid;
        grid-template-columns: 40px 1fr 0.4fr;
