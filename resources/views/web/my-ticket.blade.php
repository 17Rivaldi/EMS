                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body shadow-lg">
                        <div class="row">
                                ...
                                <div class="row justify-content-start">
                                    <div class="col-md-4">
                                        <div class="d-flex">
                                            ...
                                            <label id="tanggal-event">{{ \Carbon\Carbon::parse($transaction->event_date)->formatLocalized('%d %B %Y') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            <i class="bi bi-geo-alt text-primary mx-2"></i>
                                            <label id="lokasi-event">{{ $transaction->event->event_location }}</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <img src="{{ asset('upload/' . $transaction->event->event_image) }}" alt="Banner" class="img-fluid rounded" style="width: 360px; height: 180px;">
                            </div>
