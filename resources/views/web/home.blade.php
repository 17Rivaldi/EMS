    ...
    <div class="container d-flex justify-content-center align-items-center">
        <div class="row">
            ...
            <div class="col-12 mt-auto mb-5 text-center">
                <small>{{ $eventnya->organizer->name }}</small>

                <h1 class="text-white mb-5">{{ $eventnya->event_name }}</h1>

                <a href="{{ route('events.show', ['id' => $eventnya->id]) }}" class="btn custom-btn smoothscroll" href="#section_2">Let's begin</a>
            </div>
            ...
            <div class="col-lg-12 col-12 mt-auto d-flex flex-column flex-lg-row text-center">
                <div class="date-wrap">
                    <h5 class="text-white">
                        ...
                        {{ \Carbon\Carbon::parse($eventnya->event_date)->formatLocalized('%d-%m-%Y') }}
                    </h5>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="list-event" class="carousel slide container gap-10" data-bs-ride="carousel">
                <div class="carousel-inner w-200">
                    @foreach ($semuaevent as $key => $event)
                    <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                        <div class="col-md-3">
                            <a href="{{ route('events.show', ['id' => $event->id]) }}" style="color: black;">
                                <div class="card">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#list-event" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#list-event" data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
            </div>
            ...
            <div class="col-lg-8 col-12 mx-auto">
                ...
                <div class="tab-content shadow-lg mt-5" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-ContactMap" role="tabpanel" aria-labelledby="nav-ContactMap-tab">
                        <iframe class="google-map" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=alun%20alun%20bandung+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
