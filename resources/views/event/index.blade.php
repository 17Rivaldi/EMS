                                    ...
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ $event->event_date }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ $event->start_time }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <div class="text-center" style="display: flex; flex-wrap: nowrap;">
                                                    <a href="{{ route('event.edit', ['edit' => $event->id]) }}"
                                                        class="btn btn-warning btn-sm" style="margin-right: 7px;"
                                                        role="button">Edit</a>
