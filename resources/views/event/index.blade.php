                            ...
                            <tbody>
                                @foreach ($events as $event)
                                    <tr>
                                        ...
                                        <td class="text-center text-xs">{{ $event->totalTicketsSold }}</td>
                                        <td class="text-center text-xs">Rp.
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-2 ">
                            <h6>Gambar Event</h6>
                            <img src="{{ asset('upload/' . $event->event_image) }}" alt="Image {{ $event->event_name }}"
                                class="shadow rounded text-center event_img">
                        </div>
                        <div class="mb-2">
                            <h6>Nama Event</h6>
